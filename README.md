...
ViaSat-specific
===============
Install on our dedicated host in CDC3 (vcaemsbuild01):

`ANSIBLE_ROLES_PATH='..'
ansible-playbook site.yml -k -K -i inventory/cdc3 --sudo --user=drupp
--verbose --extra-vars="GOCD_ADMIN_EMAIL=david.rupp@viasat.com"`
